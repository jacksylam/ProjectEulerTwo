...
public class ProjectEulerTwo {
  /**
   * Computes sum of even Fibonacci numbers less than 40000000.
   * @param args Ignored.
   */
  ...
  /**
   * Finds sum of even Fibonacci numbers less than some upper bound.
   * @param upperBound The upper bound for the numbers.
